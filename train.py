...
def has_ve(layer_idx, n_layer):
    ...
    return layer_idx == n_layer - 1 or layer_idx % 4 == 1
...
UNEMBEDDING_LR = 0.015  # learning rate for lm_head (Adam)
...
while True:
    ...
    if step > 1400 and total_training_time >= TIME_BUDGET:
        break
