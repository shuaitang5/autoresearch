...
class GPT(nn.Module):
    ...
    def init_weights(self):
        ...
        for block in self.transformer.h:
            torch.nn.init.uniform_(block.attn.c_q.weight, -s*0.4, s*0.4)
            torch.nn.init.uniform_(block.attn.c_k.weight, -s*0.4, s*0.4)
            torch.nn.init.uniform_(block.attn.c_v.weight, -s*0.4, s*0.4)
